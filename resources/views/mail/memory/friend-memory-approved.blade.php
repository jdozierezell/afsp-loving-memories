	...
	<table width="640" valign="top" align="center" cellpadding="0" cellspacing="0" border="0" style="padding:0 8%;max-width: 640px; width: 100%;" class=" device-width">
		<tr>
			<td valign="top" style="font-family: 'Helvetica', Arial, sans-serif; text-align: left; font-size: 24px; line-height: 34px; color: #262626; font-weight: 600;text-align: center">
				A contributor’s addition to your Loving Memory is approved
				<br>
			</td>
		</tr>
		...
		<tr>
			<td valign="top" style="font-family: 'Helvetica', Arial, sans-serif; text-align: left;  font-size: 17px; line-height: 30px; color: #707070; font-weight: 300">
				...
				The submission from  <a href="mailto:{{$memory['friend_email']}}" target="_blank" style="color:#3D72FB; font-size: 16px; line-height: 30px;"> {{$memory['friend_email']}} </a> has been approved by our loss and healing team. Please take a moment to review your memory at
				<a style="font-family: 'Helvetica', Arial, sans-serif; text-align: left;  font-size: 17px; line-height: 30px; color: #3D72FB;" href="{{$memory['url']}}" target="_blank">{{$memory['url']}}</a> to ensure that all changes appear just as you approved.
				<br>
			</td>
		</tr>
	</table>
